        ...
        <Modal.Body>
          ...
          <Container>
            <Row>
              ...
              <h4> ● Замена поручней</h4>
              <h4> ● Замена продписывающей таблички</h4>
              <h4> ● Замена лифтового помещения</h4>
              </Col>
            </Row>
          </Container>{" "}
        </Modal.Body>
        ...
        <Modal.Body>
          ...
          <Container>
            <Row>
              ...
              <Col>
                <h2>Выполненные работы</h2>
                <h4> ● Установка лифтового помещения</h4>
