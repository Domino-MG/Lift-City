...
function Home() {
        ...
        return (
            ...
            <p> </p>
            <p  className="text"> Компания  ООО ЛИФТСИТИ является молодой компанией на данном рынке, но уже зарекомендовала себя как ответственная и обязательная организация одинаково ответственно относящаяся к каждому своему клиенту и объекту.</p>
            <p> </p>
